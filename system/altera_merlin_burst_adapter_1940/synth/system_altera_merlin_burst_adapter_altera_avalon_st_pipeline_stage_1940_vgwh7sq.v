// system_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_vgwh7sq.v

// Generated using ACDS version 25.1.1 125

`timescale 1 ps / 1 ps
module system_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_vgwh7sq #(
		...
		input  wire [157:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		...
		output wire [157:0] out_data,          //          .data,          Output Data port of Avalon Streaming Source Interface
		output wire [0:0]   out_channel        //          .channel,       Channel output port of Avalon Streaming Source Interface
	);

	system_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
