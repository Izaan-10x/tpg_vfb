// system_altera_mm_interconnect_1920_bupbv2q.v
...
`timescale 1 ps / 1 ps
module system_altera_mm_interconnect_1920_bupbv2q (
		...
		input  wire [2:0]  intel_vvp_vfb_0_av_mm_mem_write_host_burstcount,     //                                              .burstcount
		input  wire        intel_vvp_vfb_0_av_mm_mem_write_host_write,          //                                              .write
		input  wire [31:0] intel_vvp_vfb_0_av_mm_mem_write_host_writedata,      //                                              .writedata
	...
	wire   [31:0] intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_readdata;      // intel_vvp_vfb_0_av_mm_mem_write_host_agent:av_readdata -> intel_vvp_vfb_0_av_mm_mem_write_host_translator:uav_readdata
	...
	wire    [3:0] intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_byteenable;    // intel_vvp_vfb_0_av_mm_mem_write_host_translator:uav_byteenable -> intel_vvp_vfb_0_av_mm_mem_write_host_agent:av_byteenable
	...
	wire   [31:0] intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_writedata;     // intel_vvp_vfb_0_av_mm_mem_write_host_translator:uav_writedata -> intel_vvp_vfb_0_av_mm_mem_write_host_agent:av_writedata
	wire    [4:0] intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_burstcount;    // intel_vvp_vfb_0_av_mm_mem_write_host_translator:uav_burstcount -> intel_vvp_vfb_0_av_mm_mem_write_host_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                       // rsp_mux:src_valid -> intel_vvp_vfb_0_av_mm_mem_write_host_agent:rp_valid
	wire  [157:0] rsp_mux_src_data;                                                                        // rsp_mux:src_data -> intel_vvp_vfb_0_av_mm_mem_write_host_agent:rp_data
	...
	wire  [158:0] onchip_memory2_0_s1_agent_rf_source_data;                                                // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [158:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                                             // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [157:0] intel_vvp_vfb_0_av_mm_mem_write_host_agent_cp_data;                                      // intel_vvp_vfb_0_av_mm_mem_write_host_agent:cp_data -> router:sink_data
	...
	wire  [157:0] onchip_memory2_0_s1_agent_rp_data;                                                       // onchip_memory2_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [157:0] router_001_src_data;                                                                     // router_001:src_data -> rsp_demux:sink_data
	...
	wire  [157:0] cmd_mux_src_data;                                                                        // cmd_mux:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	...
	wire  [157:0] onchip_memory2_0_s1_burst_adapter_source0_data;                                          // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	system_altera_merlin_master_translator_193_lgcew2q #(
		.AV_ADDRESS_W                (32),
		.AV_DATA_W                   (32),
		.AV_BURSTCOUNT_W             (3),
		.AV_BYTEENABLE_W             (4),
		...
		.uav_burstcount         (intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_burstcount),    //  output,   width = 5,                          .burstcount
		...
		.uav_byteenable         (intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_byteenable),    //  output,   width = 4,                          .byteenable
		.uav_readdata           (intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_readdata),      //   input,  width = 32,                          .readdata
		.uav_writedata          (intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_writedata),     //  output,  width = 32,                          .writedata
		...
		.av_burstcount          (intel_vvp_vfb_0_av_mm_mem_write_host_burstcount),                                         //   input,   width = 3,                          .burstcount
		.av_write               (intel_vvp_vfb_0_av_mm_mem_write_host_write),                                              //   input,   width = 1,                          .write
		.av_writedata           (intel_vvp_vfb_0_av_mm_mem_write_host_writedata),                                          //   input,  width = 32,                          .writedata
	...
	system_altera_merlin_slave_translator_191_xg7rzxi #(
		.AV_ADDRESS_W                   (14),
		.AV_DATA_W                      (32),
		.UAV_DATA_W                     (32),
		.AV_BURSTCOUNT_W                (1),
		...
		.av_address             (onchip_memory2_0_s1_address),                         //  output,  width = 14,      avalon_anti_slave_0.address
	...
	system_altera_merlin_master_agent_1940_r3ep6da #(
		.PKT_WUNIQUE               (112),
		.PKT_DOMAIN_H              (111),
		.PKT_DOMAIN_L              (110),
		.PKT_SNOOP_H               (109),
		...
		.PKT_AWATOP_H              (136),
		.PKT_AWATOP_L              (131),
		.PKT_AWSTASHNID_H          (147),
		.PKT_AWSTASHNID_L          (137),
		.PKT_AWSTASHNIDEN          (148),
		.PKT_AWSTASHLPID_H         (153),
		.PKT_AWSTASHLPID_L         (149),
		.PKT_AWSTASHLPIDEN         (154),
		.PKT_MMUSECSID             (156),
		.PKT_MMUSID_H              (155),
		.PKT_MMUSID_L              (155),
		.PKT_DATALESS              (157),
		...
		.av_writedata          (intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_writedata),     //   input,   width = 32,          .writedata
		.av_readdata           (intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_readdata),      //  output,   width = 32,          .readdata
		...
		.av_byteenable         (intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_byteenable),    //   input,    width = 4,          .byteenable
		.av_burstcount         (intel_vvp_vfb_0_av_mm_mem_write_host_translator_avalon_universal_master_0_burstcount),    //   input,    width = 5,          .burstcount
		...
		.cp_data               (intel_vvp_vfb_0_av_mm_mem_write_host_agent_cp_data),                                      //  output,  width = 158,          .data
	...
	system_altera_merlin_slave_agent_1930_jxauz3i #(
		.PKT_ORI_BURST_SIZE_H      (103),
		.PKT_ORI_BURST_SIZE_L      (101),
		.PKT_RESPONSE_STATUS_H     (100),
		.PKT_RESPONSE_STATUS_L     (99),
		...
		.rp_data                 (onchip_memory2_0_s1_agent_rp_data),                       //  output,  width = 158,                .data
		...
		.cp_data                 (onchip_memory2_0_s1_burst_adapter_source0_data),          //   input,  width = 158,                .data
		...
		.rf_sink_data            (onchip_memory2_0_s1_agent_rsp_fifo_out_data),             //   input,  width = 159,                .data
		...
		.rf_source_data          (onchip_memory2_0_s1_agent_rf_source_data),                //  output,  width = 159,                .data
	...
	system_altera_avalon_sc_fifo_1932_onpcouq #(
		.SYMBOLS_PER_BEAT    (1),
		.BITS_PER_SYMBOL     (159),
		.FIFO_DEPTH          (2),
		.CHANNEL_WIDTH       (0),
		...
		.clk               (clock_in_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset             (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_memory2_0_s1_agent_rf_source_data),             //   input,  width = 159,        in.data
		...
		.out_data          (onchip_memory2_0_s1_agent_rsp_fifo_out_data),          //  output,  width = 159,       out.data
	...
	system_altera_merlin_router_1921_kc7nacq router (
		...
		.sink_data          (intel_vvp_vfb_0_av_mm_mem_write_host_agent_cp_data),          //   input,  width = 158,          .data
	...
	system_altera_merlin_router_1921_k4ssdbi router_001 (
		...
		.sink_data          (onchip_memory2_0_s1_agent_rp_data),                   //   input,  width = 158,          .data
		...
		.src_data           (router_001_src_data),                                 //  output,  width = 158,          .data
		.src_channel        (router_001_src_channel),                              //  output,    width = 1,          .channel
		.src_startofpacket  (router_001_src_startofpacket),                        //  output,    width = 1,          .startofpacket
		.src_endofpacket    (router_001_src_endofpacket)                           //  output,    width = 1,          .endofpacket
	);

	system_altera_merlin_burst_adapter_1940_b6dqk6a #(
		.PKT_ADDR_H                (67),
		.PKT_ADDR_L                (36),
		.PKT_BEGIN_BURST           (87),
		.PKT_BYTE_CNT_H            (78),
		...
		.sink0_data            (cmd_mux_src_data),                                        //   input,  width = 158,          .data
		...
		.source0_data          (onchip_memory2_0_s1_burst_adapter_source0_data),          //  output,  width = 158,          .data
	...
	system_altera_merlin_demultiplexer_1921_varzoui cmd_demux (
		.clk                (clock_in_out_clk_clk),                                //   input,    width = 1,       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_altera_merlin_multiplexer_1922_7zbf3yy cmd_mux (
		.clk                 (clock_in_out_clk_clk),                                //   input,    width = 1,       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	system_altera_merlin_demultiplexer_1921_varzoui rsp_demux (
		.clk                (clock_in_out_clk_clk),                                //   input,    width = 1,       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_001_src_ready),                                //  output,    width = 1,      sink.ready
		.sink_channel       (router_001_src_channel),                              //   input,    width = 1,          .channel
		.sink_data          (router_001_src_data),                                 //   input,  width = 158,          .data
	...
	system_altera_merlin_multiplexer_1922_szf4qwa rsp_mux (
		.clk                 (clock_in_out_clk_clk),                                //   input,    width = 1,       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
