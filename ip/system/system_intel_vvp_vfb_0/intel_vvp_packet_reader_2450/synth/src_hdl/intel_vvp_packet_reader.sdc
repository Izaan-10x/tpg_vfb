...
set cc_mode_instances [get_registers -nowarn fifo_inst|clock_cross_gen*] 

if {[get_collection_size $cc_mode_instances] != 0} { 

   set_max_delay -from [get_registers fifo_inst|clock_cross_gen.write_pointer_cc|bin2gray|gray_out[*]] -to [get_registers fifo_inst|clock_cross_gen.write_pointer_cc|cc_reg[0][*]] 100
   set_min_delay -from [get_registers fifo_inst|clock_cross_gen.write_pointer_cc|bin2gray|gray_out[*]] -to [get_registers fifo_inst|clock_cross_gen.write_pointer_cc|cc_reg[0][*]] -100
   set_net_delay -from [get_registers fifo_inst|clock_cross_gen.write_pointer_cc|bin2gray|gray_out[*]] -to [get_registers fifo_inst|clock_cross_gen.write_pointer_cc|cc_reg[0][*]] -max -get_value_from_clock_period dst_clock_period
   set_max_skew  -from [get_registers fifo_inst|clock_cross_gen.write_pointer_cc|bin2gray|gray_out[*]] -to [get_registers fifo_inst|clock_cross_gen.write_pointer_cc|cc_reg[0][*]] -get_skew_value_from_clock_period src_clock_period

   set_max_delay -from [get_registers fifo_inst|clock_cross_gen.read_pointer_cc|bin2gray|gray_out[*]] -to [get_registers fifo_inst|clock_cross_gen.read_pointer_cc|cc_reg[0][*]] 100
   set_min_delay -from [get_registers fifo_inst|clock_cross_gen.read_pointer_cc|bin2gray|gray_out[*]] -to [get_registers fifo_inst|clock_cross_gen.read_pointer_cc|cc_reg[0][*]] -100
   set_net_delay -from [get_registers fifo_inst|clock_cross_gen.read_pointer_cc|bin2gray|gray_out[*]] -to [get_registers fifo_inst|clock_cross_gen.read_pointer_cc|cc_reg[0][*]] -max -get_value_from_clock_period dst_clock_period
   set_max_skew  -from [get_registers fifo_inst|clock_cross_gen.read_pointer_cc|bin2gray|gray_out[*]] -to [get_registers fifo_inst|clock_cross_gen.read_pointer_cc|cc_reg[0][*]] -get_skew_value_from_clock_period src_clock_period
